...
Full LLM call lifecycle: create ephemeral session, stream response events,
accumulate to final response, destroy session.
...
async def complete(
    ...
    *,
    ...
    try:
        ...
        # Translate SDK error to kernel error
