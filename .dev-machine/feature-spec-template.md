...
|------|--------|----------|
| `path/to/new-file.py` | Create | [Description of what this file contains] |
| `path/to/existing.py` | Modify | [Description of changes] |
| `tests/path/to/test.py` | Create | [Tests for this feature] |
